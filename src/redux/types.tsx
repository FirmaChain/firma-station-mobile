...
export const UPDATE_VALIDATORS_STATE = 'UPDATE_VALIDATORS_STATE';
...
export const HANDLE_NOTIFICATION_ENABLED = 'HANDLE_NOTIFICATION_ENABLED';
export const HANDLE_NOTIFICATION_PERMISSION_PROMPTED = 'HANDLE_NOTIFICATION_PERMISSION_PROMPTED';
