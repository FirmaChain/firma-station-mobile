        ...
        <View style={[styles.boxH, { backgroundColor: BoxColor, paddingHorizontal: 20, paddingTop: 10 }]}>
            <View style={{ height: '100%', justifyContent: 'flex-start' }}>
                <Image
                    ...
                    source={
                        avatarError || validator.avatar === null || validator.avatar === '' ? VALIDATOR_PROFILE : { uri: validator.avatar }
                    }
                />
            </View>
            <View style={[styles.boxV, { flex: 1 }]}>
                <Text
                    numberOfLines={2}
                    ellipsizeMode="tail"
                    style={[styles.moniker, { paddingBottom: validator.description || validator.website ? 8 : 0 }]}
                >
                    {validator.moniker}
                </Text>
