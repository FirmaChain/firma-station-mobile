...
// Test-only compatibility fixture: the product module is absent from this checkout.
...
export class ApiError extends Error {
    ...
    static from(error: unknown): ApiError {
        ...
        if (isSyntaxError(error)) return new ApiError('parse', 'The server returned invalid JSON.');
